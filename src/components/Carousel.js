...
const items = [
  {
    src: jar,
    altText:
      "3d model of a craft jar containing a scene with a snowman and several Christmas trees",
    // caption: 'Slide 1'
  },
  {
    src: cathedralinside,
    altText:
      "3d model of the inside of a cathedral with chandeliers and stained glass",
    // caption: 'Slide 2'
  },
  {
  ...
  },
  {
    src: corn,
    altText:
      "3d model of a halloween themed scene with candycorn, a pumpkin, and a coffin",
    // caption: 'Slide 4'
  },
  {
    src: chess,
...
const Carousel2 = (props) => {
  ...
  return (
    <Container>
      ...
      <Para>
        In 2019, I took up 3D modeling as a hobby after competing a{" "}
        <a
          href="https://drive.google.com/file/d/1N5NmDESlUzYN9YXT3kYSJrokFuaylwX9/view?usp=sharing"
          target="_blank"
        >
          <SpanLink>65+ hour</SpanLink>
        </a>{" "}
        Udemy course in <Span>Blender</Span>. I've found it a fun creative
        outlet and a great learning experience. In some ways it inspired me to{" "}
        <Span>really pursue web development</Span>, proving to myself that I
        could <Span>quickly pick up a new skill</Span> for the sake of it,
        remotely, with no extrinsic incentives. Thus far, my 3D models have been
        utilized for paid commission, 3D prints, and contributing to my web
